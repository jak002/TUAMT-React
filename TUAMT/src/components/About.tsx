...
const About = () => (
    <div className="flex text-center flex-col justify-center max-w-5xl bg-white p-2 rounded-2xl shadow-2xl">
        <h1>About</h1>
        ...
        <ImageCard url={imgDog} imageText="...But is the pothole a good boy?"/>
        </div>
        <div className="flex flex-col-reverse md:flex-row justify-center m-3">
            <ImageCard url={imgswift} imageText="Source: https://www.jpost.com/science/space/article-785118"/>
        <div className="flex text-start flex-col  justify-center mx-2 p-2">
        ...
        <div className="flex text-start flex-col justify-center mx-2 p-2">
            ...
            <p><i>Make a React app with routing, at least 5 components, RTK, TypeScript, and external calls to an API.</i></p>
            <p>Those random pics you see on this page? They're component 5.</p>
            </div>
        <ImageCard url={imgwmach} imageText="God dammit"/>
        </div>
        <div className="flex flex-col-reverse md:flex-row justify-center m-3">
            <ImageCard url={imgUrl1} imageText="Still don't get how this even happened."/>
            <div className="flex text-start flex-col justify-center mx-2 p-2">
        ...
        <div className="mx-2 p-2">
            ...
            <p>If you <i>do</i> wanna keep in touch tho, <a href="https://bsky.app/profile/mewnlightro.se" className="underline hover:text-blue-600">you can always follow me on Bluesky.</a></p>
        ...
        <div className="mx-2 p-2">
            ...
            <div>
            <details>
            <summary className=" list-none cursor-pointer"><h2>If you do want a bit of a political stance though...</h2></summary>
            <div className="mx-2 p-2">
